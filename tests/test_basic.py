...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "pandera_model",
            "target.index_model.TestSingleIndexModel",
            [
                "",
        ...
        (
            "pandera_model",
            "target.index_model.TestMultiIndexModel",
            [
                "",
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "pandera_schema",
            "target.index_schema.single_index_schema",
            [
                "",
                ".. py:pandera_schema:: single_index_schema",
                "   :module: target.index_schema",
                "",
                ...
                "         - **strict** = True",
                "",
                "   .. py:pandera_field:: single_index_schema.key",
                "      :type: Index[str]",
                "      :title: First Index type field",
                "",
                "      Field whose dtype is Index",
        ...
        (
            "pandera_schema",
            "target.index_schema.multi_index_schema",
            [
                "",
                ".. py:pandera_schema:: multi_index_schema",
                "   :module: target.index_schema",
                "",
                ...
                "         - **strict** = True",
                "",
                "   .. py:pandera_field:: multi_index_schema.key1",
                "      :type: Index[str]",
                "      :title: First Index type field",
                "",
                "      Field whose dtype is Index",
                ...
                "         - **str_matches('^AIPE-[0-9]+$')**",
                "",
                "   .. py:pandera_field:: multi_index_schema.key2",
                "      :type: Index[str]",
                "      :title: Second Index type field",
                "",
                "      Field whose dtype is Index",
...
def test_schema(documenter, object_path, expected_rst, autodocument):
    actual = autodocument(
        documenter=documenter,
        object_path=object_path,
        testroot="basic",
